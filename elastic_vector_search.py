...
class ElasticVectorSearch(VectorStore, ABC):
    ...
    def __init__(
        ...
        try:
            self.client = elasticsearch.Elasticsearch(cloud_id=cloud_id, basic_auth=(username, password))
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        vectorsearch = cls(cloud_id=cloud_id, username=username, password=password, index_name=index_name, embedding=embedding, **kwargs)
